...
def load(path_fixed,path_moving, vectorize=False):
    ...
    if vectorize :
        return to_vector(fixed_image.get_fdata()), to_vector(moving_image.get_fdata()), fixed_mask.get_fdata(), moving_mask.get_fdata()
        
    return fixed_image.get_fdata(), moving_image.get_fdata(), fixed_mask.get_fdata(), moving_mask.get_fdata()
